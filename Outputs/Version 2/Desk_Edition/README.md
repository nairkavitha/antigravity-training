# Antigravity 2.0 · HR Desk Edition

The Desk Edition of the Jio Agentic AI training portal: everything in the original programme, plus the **Monday Morning Library**, ten real Indian HR missions (attrition, PIP, POSH annual report, calibration, F&F, CTC structuring, survey mining, leadership MIS, hiring kits, holiday planning) with synthetic datasets, field-tested Antigravity briefs, and audit checklists. Finish a mission tonight, use the pattern at work tomorrow.
...
│   ├── missions/           # 10 mission data packs (attrition, pip, posh, fnf, ...)
...
The portal is self-paced (about 3 hours 20 minutes of guided content) and has 8 tabs:
...
6. **🗂 Missions**: the Monday Morning Library, ten real Indian HR workflows with sandbox data (`HR_Mission_Control/missions/`), copy-paste briefs and audit checklists; statute-touching missions are explicitly drafts for Legal review
7. **Module 5 · Help**: the five common failure patterns and how to recover, the HITL commitment
8. **Glossary**: 50+ flip-card terms with corporate-life analogies, searchable and filterable by category
